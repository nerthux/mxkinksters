...
## Cómo verificar un evento antes de ir
...
Si el organizador no puede responderte estas preguntas o se pone evasivo, ya tienes información útil.

---

## Políticas de consentimiento: lo que debes buscar (y lo que debe darte mala espina)
...
**¿Qué quiero explorar hoy?** No en abstracto — específicamente. ¿Observar? ¿Tener una conversación? ¿Participar en algo en particular?

**¿Qué no quiero que pase?** Lista mental de límites concretos. No tiene que ser exhaustiva, pero sí consciente.

**¿Con quién voy y cómo nos comunicamos?** Si vas acompañado, definir señales entre ustedes — una forma de decir "quiero irme" o "necesito que vengas" — puede hacer una diferencia real.

**¿Cuál es mi plan si algo me incomoda?** Tener la respuesta lista antes de que pase es mucho más fácil que improvisar en el momento.

Si vas llegando al mundo kink y todavía estás armando el vocabulario para estas conversaciones, el [Glosario Kink y BDSM](/blog/glosario-kink-y-bdsm-terminos-esenciales-explicados/) puede ayudarte a ponerle nombre a lo que estás pensando.
...
- **Espacios para conversar** dentro del evento antes de irte.
...
## Lista de verificación: antes de entrar a un evento swinger o kink en Tijuana

Esto es lo que yo repasaría. No como checklist de ansiedad, sino como recordatorio de que llegaste preparado:

**Sobre el evento:**
- [ ] Identifiqué al organizador y verifiqué su reputación en comunidad
- [ ] Leí las reglas y política de consentimiento del espacio
- [ ] Sé cómo contactar al staff si necesito algo dentro del evento
- [ ] Conozco la política de fotografía del lugar
- [ ] El evento tiene proceso de selección o acceso controlado

**Sobre mí:**
- [ ] Tengo claros mis límites para esta noche — qué sí y qué no
- [ ] Tengo una safeword o señal acordada si voy acompañado
- [ ] Sé cómo me voy a mover si algo me incomoda
- [ ] Tengo un plan de aftercare, aunque sea básico

**Sobre el entorno:**
- [ ] Sé cómo llegar y cómo salir del lugar de forma independiente
- [ ] Tengo cargado el teléfono y acceso a transporte propio
- [ ] No dependo de alguien más para poder irme cuando quiera

No voy a mentirte: la primera vez no todo esto lo tenía resuelto. Pero haberlo pensado antes hizo que me sintiera más presente dentro del evento y menos en modo de alerta constante.
...
Button, K., et al. (2025). Barriers to reporting sexual harassment in Australian nightlife settings. *Journal of Sexual Aggression*. https://doi.org/10.1080/13552600.2025.2558611

González-Fernández, J. (2022). Sexual violence by means of chemical submission in the context of nightlife. *International Journal of Forensic Sciences*. https://doi.org/10.23880/ijfsc-16000276
